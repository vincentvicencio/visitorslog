<div class="addvisitor" id="viewVisitorModal" style="display: none;">
 ...
 <!-- <div class="addvisitor" id="viewVisitorModal" style="display: none;">
    <div class="addvisitormodal" style=" background-color: rgba(0, 0, 0, 0.5)">
        <div class="panel">
            <div class="header fs-4" id="modalTitle">Visitor Details</div>
            <div class="subheader mb-3">Viewing recorded visitor information</div>
            <button type="button" class="btn-close" id="closeViewModal"></button>
            <div class="form">
                <div class="details">
                    <div class="input-holder floating">
                        <input type="text" id="view_id_number" class="form-control" placeholder=" " readonly>
                    ...
                    <div class="input-holder floating">
                        <input type="text" id="view_first_name" class="form-control" placeholder=" " readonly>
                        <label>First Name</label>
                    </div>
                    <div class="input-holder floating">
                        <input type="text" id="view_last_name" class="form-control" placeholder=" " readonly>
                        <label>Last Name</label>
                    </div>
                    <div class="input-holder floating w-100">
                        <textarea id="view_address" class="form-control" placeholder=" " rows="3" readonly></textarea>
                        <label>Address</label>
                    </div>
                </div>
                <div class="capture">
                    <div class="header">Visitor Image</div>
                    <div class="imgholder" id="view_image_holder">
                        No Image
                    </div>
                </div>
            </div>
            <div class="panel-buttons">
                <button type="button" class="clear" id="closeViewBtn">Close</button>
            </div>
        </div>
    </div>
</div>
