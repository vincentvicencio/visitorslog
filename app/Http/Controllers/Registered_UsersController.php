        ...
        foreach ($data as $d) { 
            ...
            $newData[$i] = [
                ...
                'status' => $d->status === 'Enabled' 
                                        ? '<span class="d-inline-flex focus-ring py-1 px-2 text-decoration-none border rounded-2 border-success text-success">Active</span>' 
                                        : '<span class="d-inline-flex focus-ring py-1 px-2 text-decoration-none border rounded-2 border-danger text-danger">Disabled</span>',
